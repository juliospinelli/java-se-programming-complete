...
public class ProductManager {
    ...
    public void printProductReport() {
        ...
        txt.append(MessageFormat.format(resources.getString("product"), this.product.getName(),
                moneyFormat.format(this.product.getPrice()), this.product.getRating().getStars(),
                dateFormat.format(this.product.getBestBefore())));
        txt.append('\n');
